...
Are We Compatible? is a local-first application with no account system, analytics service, or advertising SDK. Answers remain in browser storage unless a player explicitly exports a backup or sends them to their partner over the encrypted WebRTC data channel.
